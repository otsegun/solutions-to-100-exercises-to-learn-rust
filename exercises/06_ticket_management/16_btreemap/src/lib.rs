...
//     type IntoIter = Map<Iter<'a, TicketId, Ticket>, fn((&'a TicketId, &'a Ticket)) -> &'a Ticket>;

//     fn into_iter(self) -> Self::IntoIter {
//         // We use a function pointer (|(_, v)| v) to keep the type nameable.
//         self.tickets.iter().map(|(_id, ticket)| ticket)
//     }
// }
